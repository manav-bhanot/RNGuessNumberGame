...
import {Alert, KeyboardAvoidingView, StyleSheet, TextInput, View, useWindowDimensions, ScrollView} from 'react-native';
...
function StartGameScreen(props: any) {
  ...
  const marginTopDistance = dimensions.height < 400 ? 30 : 100;
